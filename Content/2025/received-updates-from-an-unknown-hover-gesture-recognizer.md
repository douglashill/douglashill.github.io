...
micro: We’re seeing a UIKit crash introduced in iOS 26.1: `NSInternalInconsistencyException -[UIPencilInteraction _handleHoverGestureRecognizer:]: Received updates from an unknown hover gesture recognizer` [Full post]()
