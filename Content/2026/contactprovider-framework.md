...
TIL about the [ContactProvider](https://developer.apple.com/documentation/contactprovider) framework on iOS (not Mac). Sounds like a way to build an end-to-end encrypted replacement for iCloud/CalDAV contacts sync if you can get your head around the difference between `ContactItemEnumerating` and `ContactItemEnumerator`.
